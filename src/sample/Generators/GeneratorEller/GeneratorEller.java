package sample.Generators.GeneratorEller;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class GeneratorEller {
    ...
    static public void driver(int[][] maze) {
        size = maze.length / 2;
    ...
    static void printMaze(Cel[] row, int rowPos, int[][] maze) {
        rowPos = 2 * rowPos + 1;
        for (int i = 0; i < row.length; i++) {
            if (row[i].right)
                maze[rowPos][2 * i + 2] = 1;
